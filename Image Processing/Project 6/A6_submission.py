...
class Classifier(nn.Module):
    def __init__(self):
        ...
        define the CNN architecture including number and configurations of layers and their connectivity
        """
        ...
        self.fc3 = nn.Linear(256, 11)  # 10 classes + 1 background
    ...
    def init_weights(self):
        ...
        optionally initialize the weights of your CNN using a custom distribution (or load pretrained weights)
        """
